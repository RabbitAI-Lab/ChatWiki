...
// GET /api/fs/workspaces/projects?workspace={workspaceId}
...
export async function DELETE(req: NextRequest) {
  ...
  unlinkProjectFromWorkspace("", "", workspace, projectId);
  return NextResponse.json({ success: true });
}
