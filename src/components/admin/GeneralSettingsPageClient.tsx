  ...
  return (
    <div className="h-full flex flex-col">
      ...
      <div className="flex items-center justify-between px-6 py-4 bg-white border-b border-gray-200">
        <div>
          <h1 className="text-lg font-semibold text-gray-800">Site Settings</h1>
      ...
      <div className="flex-1 overflow-y-auto p-6">
        <div className="bg-white rounded-lg border border-gray-200 p-4 max-w-2xl">
          ...
          <div className="mt-4 p-3 bg-gray-50 rounded-md">
            <Text type="secondary" className="text-xs">
              Preview: <span className="font-medium text-gray-700">{brandName || DEFAULT_BRAND_NAME}</span> — Document Management & Publishing
            </Text>
          </div>
        </div>
      </div>
