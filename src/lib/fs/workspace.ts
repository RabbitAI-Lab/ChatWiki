...
export const listWorkspaces: (type: "personal" | "enterprise", accountId: string, orgId?: string) => WorkspaceMeta[] = workspaceEntityCrud.list as any;
export const createWorkspace: (type: "personal" | "enterprise", accountId: string, name: string, orgId?: string) => WorkspaceMeta = workspaceEntityCrud.create as any;
